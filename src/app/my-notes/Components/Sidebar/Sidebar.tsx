          ...
          sideBarMenu.map((menu, index) => (
            <li
              ...
              className={`flex gap-1 items-center ${
                menu.isSelected ? "bg-purple-600 text-white" : ""
              } p-[7px] px-2 rounded-md w-[80%] cursor-pointer `}
            >
              {menu.icons}
              <span>{menu.name}</span>
            </li>
